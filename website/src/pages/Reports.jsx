  ...
  return (
    <>
      ...
      <Card className="p-6 mb-6">
        <h3 className="font-bold text-gold-200 mb-4">تقرير الحضور</h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {attRows.map((r) => (
                <tr key={r.id} className="border-b border-dark-800/60 hover:bg-dark-900/40">
                  <td className="py-3 px-3 text-gray-200">{r.name}</td>
                  <td className="py-3 px-3 text-gold-300 font-semibold">{r.present_days}</td>
      ...
      <Card className="p-6">
        <h3 className="font-bold text-gold-200 mb-4">تقرير المهام</h3>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {taskRows.map((r) => (
                <tr key={r.id} className="border-b border-dark-800/60 hover:bg-dark-900/40">
                  <td className="py-3 px-3 text-gray-200">{r.name}</td>
                  <td className="py-3 px-3 text-gold-300 font-semibold">{r.total}</td>
                  <td className="py-3 px-3 text-emerald-400">{r.completed}</td>
                  <td className="py-3 px-3 text-sky-400">{r.in_progress}</td>
