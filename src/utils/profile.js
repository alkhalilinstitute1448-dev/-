...
function validateProfile(body) {
  if (body.father_status !== undefined && !['alive', 'deceased'].includes(body.father_status)) {
    return 'حالة الأب غير صحيحة';
  }
  if (body.mother_status !== undefined && !['alive', 'deceased'].includes(body.mother_status)) {
  ...
  if (body.gender !== undefined && body.gender !== '' && !['male', 'female'].includes(body.gender)) {
